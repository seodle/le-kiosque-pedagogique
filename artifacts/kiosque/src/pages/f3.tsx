...
function statusBadge(status: string) {
  const map: Record<string, string> = {
    ...
    closed_resolved: "bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300",
  ...
  return (
    <AppLayout>
      <div className="max-w-4xl mx-auto py-6 space-y-8">
        <div>
          <h1 className="text-2xl font-bold">Personne ressource externe</h1>
          <p className="text-muted-foreground text-sm mt-1">
            Toutes les demandes remontées — prenez en charge celles pour lesquelles vous êtes le plus à même de répondre
          </p>
        </div>
        ...
        <section>
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-lg font-semibold">Demandes remontées en attente</h2>
          ...
          {!poolLoading && pool?.length === 0 && (
            <Card className="border-dashed">
              <CardContent className="py-12 text-center text-muted-foreground">
                ...
                <p>Aucune demande remontée en attente</p>
              </CardContent>
            </Card>
          )}
